const settings = {
  ...
  function initializeGlide() {
    ...
    const perView = settings.enable_custom_tiles_per_page
      ? Math.floor(screenSize / tileWidth)
      : settings.tiles_per_page;
  
    console.log('initializeGlide screenSize', screenSize);
    console.log('initializeGlide perView', perView);
  ...
  const customExpandedTileTemplate = (sdk) => {
    ...
    const shopspotEnabled =
      sdk.isComponentLoaded('shopspots') && settings.expanded_tile_show_shopspots;
    const productsEnabled =
      sdk.isComponentLoaded('products') && settings.expanded_tile_show_products;
                      ...
                      <div class="content-inner-wrapper">
                          ...
                          <div class="caption">
                              <p class="caption-paragraph">${
                                tile.message &&
                                settings.expanded_tile_show_caption
                                  ? tile.message
                                  : ''
                              }</p>
                              ${
