...
export function getConfig(widgetContainer: WidgetContainer): IWidgetSettings {
  ...
  return {
    ...
    cta_button_background_color: widgetStyle?.cta_button_background_color ?? "000000",
    cta_button_font_color: widgetStyle?.cta_button_font_color ?? "ffffff",
    cta_button_font_size: widgetStyle?.cta_button_font_size ?? 18,
