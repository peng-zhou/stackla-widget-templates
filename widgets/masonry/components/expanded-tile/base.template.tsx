              ...
              <div className="caption">
                ...
                {widgetSettings.expanded_tile_show_sharing ? (
                  <div className="ugc-inline-share-buttons">
                    <a
                      href={`https://www.addtoany.com/add_to/facebook?linkurl=${tile.original_url}&linkname=${tile.name}`}
                      target="_blank"
                    ...
                    <a
                      href={`https://www.addtoany.com/add_to/x?linkurl=${tile.original_url}&linkname=${tile.name}`}
                      target="_blank"
                      rel="noopener noreferrer">
                      <img
                    ...
                    <a
                      href={`https://www.addtoany.com/add_to/pinterest?linkurl=${tile.original_url}&linkname=${tile.name}`}
                      target="_blank"
                      rel="noopener noreferrer">
                      <img
                    ...
                    <a
                      href={`https://www.addtoany.com/add_to/linkedin?linkurl=${tile.original_url}&linkname=${tile.name}`}
                      target="_blank"
                      rel="noopener noreferrer">
                      <img
                    ...
                    <a
                      href={`https://www.addtoany.com/add_to/email?linkurl=${tile.original_url}&linkname=${tile.name}`}
                      target="_blank"
                      rel="noopener noreferrer">
                      <img
