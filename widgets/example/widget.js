sdk.addLoadedComponents(['expanded-tile', 'products','shopspots','add-to-cart','cross-sellers']);
...
sdk.addEventListener('tileExpand', (e) => { buttons.style.display = 'none'; });
sdk.addEventListener('expandedTileClose', (e) => { buttons.style.display = '';});
sdk.addEventListener('tilesUpdated', (e) => {
